...
public class GenerationEntities {
    ...
    private static final List<String> m_lastnames = Arrays.asList(
            "Иванов", "Петров", "Сидоров", "Козлов", "Михайлов",
            "Васильев", "Алексеев", "Егоров", "Николаев", "Кузнецов",
            "Ковалев", "Борисов", "Григорьев", "Дмитриев", "Федоров"
    );
    ...
    public static void generation() {
        ...
        for (int i = 0; i < NUM_BANKS; i++) {
            ...
            for (int j = 0; j < NUM_OFFICES; j++, idOffice++, idAtm++) {
                bankOfficeService.create(idOffice, "Отделение банка №" + (j + 1), bankService.read(idBank), "г. Белгород, ул. Победы " + (idOffice + 1), true, true, true, true, true, randomDouble(100000 + j* 3000, 100000 + j * 15000));
